let PROJECTS = [
    ...
    },
    {
        ...
        img:'movie.png',
        title:'Project Movie',
        desc:'A movie search application built with HTML, CSS, JavaScript, and The Movie Database API. It allows users to search for movies, view details, and save their favorites.',
        link:'https://movi-app-front.vercel.app/'
    },
    {
        video:"project3.mp4",
        img:'resturant.png',
